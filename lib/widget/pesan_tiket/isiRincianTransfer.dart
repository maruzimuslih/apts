...
class BoxAppBarRincianTransfer extends StatelessWidget {
  @override
        ...
        Row(
          ...
          children: <Widget>[
            Padding(
              ...
              child: Text("Pembayaran via Transfer",
...
class BoxBodyRincianTransfer extends StatefulWidget {
  @override
  _BoxBodyRincianTransferState createState() => _BoxBodyRincianTransferState();
}

class _BoxBodyRincianTransferState extends State<BoxBodyRincianTransfer> {
  int sisaKursi;
  String idPenumpang,
      idArmada,
      idPJ,
  ...
  inputDataPesanan() async{
    ...
    ubahStatusDipesan();
    await delayedSend();
    Navigator.of(context).pushNamedAndRemoveUntil('/banktransfer', ModalRoute.withName('/'));
  }
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: !isLoading
                ? BtnOval(
                  label: "Pilih Pembayaran Bank Transfer",
                    ...
                    return showDialog(
                      ...
                      builder: (context) {
                        return new AlertDialog(
                          title: new Text('Lanjutkan Pembayaran'),
                          content: new Text(
