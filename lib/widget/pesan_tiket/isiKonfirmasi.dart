...
class BoxAppBarKonfirmasi extends StatefulWidget {
  @override
  _BoxAppBarKonfirmasiState createState() => _BoxAppBarKonfirmasiState();
}

class _BoxAppBarKonfirmasiState extends State<BoxAppBarKonfirmasi> {
  String kode;
...
class BoxBodyKonfirmasi extends StatefulWidget {
  @override
  _BoxBodyKonfirmasiState createState() => _BoxBodyKonfirmasiState();
}

class _BoxBodyKonfirmasiState extends State<BoxBodyKonfirmasi> {
