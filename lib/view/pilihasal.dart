...
class PilihKotaAsal extends StatefulWidget {
  @override
  _PilihKotaAsalState createState() => _PilihKotaAsalState();
}

class _PilihKotaAsalState extends State<PilihKotaAsal> {
  var list;
      ...
      body: FutureBuilder<List>(
          ...
          builder: (context, snapshot) {
            ...
            return snapshot.hasData
                ? ListView.builder(
                    itemCount: kotaTerpilih!=null?1:list.length,
